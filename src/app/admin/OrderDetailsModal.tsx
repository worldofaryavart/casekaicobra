      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl">
            Order <span className="font-mono bg-slate-100 px-2 py-1 rounded text-sm">{id.substring(0, 8)}</span>
          </DialogTitle>
          <DialogDescription>
            Placed on {new Date(createdAt).toLocaleDateString()} at {new Date(createdAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="border rounded-md">
          <h3 className="font-medium p-4 border-b bg-slate-100">Product Configuration</h3>
                  ...
                  <div className="text-sm">
                    {configuration.isCustom ? (
                      ...
                      <div className="mb-4">
                        ...
                        <p className="font-medium mt-2">{configuration.product.title}</p>
                      ...
                      {configuration.color ? (
                        <>
                          <div 
                            ...
                            style={{ backgroundColor: configuration.color.hex || '#ccc' }}
                          ></div>
                ...
                <div className="mt-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {configuration.imageUrl && (
                      <div>
                        <p className="text-xs text-muted-foreground mb-1">Original Design</p>
                        <img 
                    ...
                    {configuration.croppedImageUrl && (
                      <div>
                        <p className="text-xs text-muted-foreground mb-1">Cropped Design</p>
                        <img 
          ...
          {!configuration && <p className="p-4">No configuration data available</p>}
        </div>
